      ...
      <section class="dashboard-banner p-5 sm:p-6">
        <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <h2 class="mt-2 text-2xl font-bold text-white">Operational Snapshot</h2>
          ...
          <div class="p-5">
            <div v-if="chart.length" class="flex h-64 items-end gap-2">
              <div v-for="item in chart" :key="item.label" class="flex min-w-0 flex-1 flex-col items-center gap-2">
                <div class="w-full rounded-t bg-blue-500 shadow-lg shadow-blue-500/30" :style="{ height: barHeight(item.value) }"></div>
